    ...
    <div className="min-h-screen bg-logia-900 text-gray-100 font-sans relative">
      <header className="bg-logia-800 border-b border-logia-700 p-4 flex justify-between items-center sticky top-0 z-20 shadow-md">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button onClick={onLogout} className="text-sm text-gray-400 hover:text-white border border-logia-700 px-3 py-1 rounded bg-logia-900">
            Salir
          </button>
        </div>
      </header>
      ...
      {showInstallModal && (
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4" onClick={() => setShowInstallModal(false)}>
          <div className="bg-logia-800 rounded-xl max-w-lg w-full border border-logia-700 shadow-2xl" onClick={event => event.stopPropagation()}>
            <div className="p-6">
              ...
              <div className="space-y-4 text-gray-300 text-sm">
                <p className="text-indigo-300 font-medium">Instala la app en tu dispositivo para acceso rápido y mejor experiencia.</p>
              ...
              <button onClick={() => setShowInstallModal(false)} className="w-full mt-6 bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-3 rounded-lg">
                Entendido
              </button>
            </div>
          </div>
